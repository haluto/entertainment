...
export const ITEM_Z = 'item_Z';
export const ITEM_ANTI_Z = 'item_anti_Z';

export class Item_Z extends Item {
  ...
  getItem = () => {
    ...
    if (this.curDir === CONSTANT.ITEM_DIR.UP || this.curDir === CONSTANT.ITEM_DIR.DOWN) {
      ...
      this.itemData[1][1] = 1; //    o o x o
      this.itemData[1][2] = 1; //    o x x o
      this.itemData[2][0] = 1; //    o x o o
...
export class Item_Anti_Z extends Item {
  ...
  getItem = () => {
    ...
    if (this.curDir === CONSTANT.ITEM_DIR.UP || this.curDir === CONSTANT.ITEM_DIR.DOWN) {
      ...
      this.itemData[1][1] = 1; //    o x x o
      this.itemData[1][2] = 1; //    x x o o
      this.itemData[2][1] = 1; //    o o o o
    } else if (this.curDir === CONSTANT.ITEM_DIR.RIGHT || this.curDir === CONSTANT.ITEM_DIR.LEFT) {
